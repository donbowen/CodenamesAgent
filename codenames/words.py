"""Default word list for Codenames (official 400-word list subset)."""
...
DEFAULT_WORDS = [
    ...
    "CABLE", "CAMP", "CANADA", "CAP", "CAPITAL", "CAR", "CARD", "CARROT",
    ...
    "LEMONADE", "LIMOUSINE", "LINE", "LINK", "LION", "LOCK", "LOG", "LONDON",
    "LUCK", "MAIL", "MAMMOTH", "MAPLE", "MARBLE", "MARCH", "MASS", "MATCH",
    "MERCURY", "MEXICO", "MICROSCOPE", "MILLIONAIRE", "MINE", "MISSILE",
    ...
    "RULER", "RUSSIA", "SADDLE", "SAFE", "SAIL", "SATURN", "SCALE", "SCHOOL",
    "SCIENTIST", "SCORPION", "SCREEN", "SCUBA DIVER", "SEAL", "SERVER",
    ...
    "TRAIN", "TRAVEL", "TRIANGLE", "TRIP", "TRUNK", "TUBE", "TURKEY",
    "UNDERTAKER", "UNICORN", "VACUUM", "VAN", "VET", "VOLUME", "WALL",
